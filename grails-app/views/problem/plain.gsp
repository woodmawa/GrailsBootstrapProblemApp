...
<p>now table with border</p>
    ...
    <div class="col-xs-4">
        ...
        <table class="table table-bordered table-condensed">
            <caption> bordered condensed Map using alert class table</caption> <!-- appears at bottom -->
...
<div class="row">
    <div class="col-xs-4">
        ...
        <table class="table table-bordered table-condensed">
            <caption> bordered condensed Map class thead-blue table</caption> <!-- appears at bottom -->
